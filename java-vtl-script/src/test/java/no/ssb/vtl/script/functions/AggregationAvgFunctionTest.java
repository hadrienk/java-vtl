...
public class AggregationAvgFunctionTest {
    ...
    public void testReturnType() {
        AggregationAvgFunction function = new AggregationAvgFunction();
        assertThat(function.getVTLReturnTypeFor(Integer.class)).isEqualTo(Double.class);
        assertThat(function.getVTLReturnTypeFor(Long.class)).isEqualTo(Double.class);
        assertThat(function.getVTLReturnTypeFor(Double.class)).isEqualTo(Double.class);
        assertThat(function.getVTLReturnTypeFor(Float.class)).isEqualTo(Double.class);
    }
