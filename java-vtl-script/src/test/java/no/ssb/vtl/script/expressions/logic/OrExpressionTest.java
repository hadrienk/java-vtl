...
public class OrExpressionTest {
    ...
    public void testTruth() throws Exception {
        ...
        builder.put(falsy, truthy, truthy);
        builder.put(falsy, nully, nully);
        builder.put(truthy, falsy, truthy);
        builder.put(truthy, truthy,truthy);
        builder.put(truthy, nully, truthy);
        builder.put(nully, falsy, nully);
        builder.put(nully, truthy,truthy);
        ...
        for (Table.Cell<VTLExpression, VTLExpression, VTLExpression> test : builder.build().cellSet()) {
            ...
            VTLExpression result = new OrExpression(left, right);
